...
Prefer scaffolding from the bundled templates or `new_notebook.py` (for example, `$SKILL_DIR/scripts/new_notebook.py`) instead of hand-authoring raw notebook JSON.
