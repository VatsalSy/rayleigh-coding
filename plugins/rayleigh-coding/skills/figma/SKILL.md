...
name: figma
description: >-
  Use when a Figma URL or node ID appears, or the user asks to fetch design
  context, screenshots, variables, or assets via the Figma MCP server, or to
  fix Figma MCP setup. Full design-to-code implementation is
