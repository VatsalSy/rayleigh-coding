...
**Bad:** `T3: Build the backend and hook it up to the frontend when that's ready.`
**Good:** `T3: [depends_on: [T1]] Create repository layer in src/db/; validation: unit tests pass.`
