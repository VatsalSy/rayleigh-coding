---
name: netlify-deploy
description: Use when the user says "deploy to Netlify", "host this on Netlify", or asks to publish or link a site/repo there — preview and production deploys via the Netlify CLI (`npx netlify`).
---
...
```
The deploy needs escalated network access to deploy to Netlify. I can rerun with escalated permissions—want me to proceed?
```
